...
#řešení 1: Brute-force metoda -určitě elegantnější
...
jednociferna = {0: "nula",1: "jedna", 2: "dva",3: "tři",4: "čtyři", 5: "pět",6: "šest",7: "sedm",8:  "osm",9: "devět"}
...
def cislo_text(cislo):
    ...
    if cislo_int == 100:
        ...
        return jednociferna[cislo_int]
    #zaznamenáváme si znaky, protože teď už se jedná o dvojcifry, takže (snad) nebude házet errory
    elif cislo_int >= 10 and cislo_int < 20: 
        #prvni_znak = cislo[0]  # druhá číslice (desítky)
